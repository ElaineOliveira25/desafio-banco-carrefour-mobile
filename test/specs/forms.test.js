...
describe('Preenchimento do formulário', () => {
    ...
    it('[TC-10] Deve preencher o formulário, interagir com switch e dropdown, e validar o modal', async () => {
        ...
        await inputResult.waitForDisplayed({ timeout: 10000 });
        ...
        await driver.waitUntil(
            ...
            { timeout: 10000, timeoutMsg: 'Switch não passou para ON após 10s' },
        );
        ...
        await (await FormsPage.modalTitle).waitForDisplayed({ timeout: 10000 });
        await (await FormsPage.modalMessage).waitForDisplayed({ timeout: 10000 });
        await (await FormsPage.modalButton1).waitForDisplayed({ timeout: 10000 });
        await (await FormsPage.modalButton2).waitForDisplayed({ timeout: 10000 });
        await (await FormsPage.modalButton3).waitForDisplayed({ timeout: 10000 });
        allure.endStep('passed');
